/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 410f7730b0eab36aa2b7955cfbacd0d7)
// Runtime types generated with workerd@1.20260921.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	DeploymentController: DurableObjectNamespace<import("./src/server").DeploymentController>;
	ChatAgent: DurableObjectNamespace<import("./src/server").ChatAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "DeploymentController";
	}
