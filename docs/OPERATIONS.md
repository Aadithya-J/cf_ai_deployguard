...
For the live demo and overview, start with [README](../README.md).
...
- [Deployed backend verification](verification/BACKEND_VERIFICATION.md)
- [Live failure and traffic-confirmed rollback](verification/ROLLBACK_VERIFICATION.md)
- [Dashboard verification](verification/DASHBOARD_VERIFICATION.md)
